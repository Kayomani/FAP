    ...
    public static class ListViewSorter
    {
        ...
        private static void GridViewColumnHeaderClickedHandler(object sender, RoutedEventArgs e)
        {
            ...
            if (headerClicked != null)
            {
                ...
                try
                {
                    var binding = ((Binding)ListViewSorter.GetSortBindingMember(headerClicked.Column));
            ...
            if (view != null)
            {
                try
                {
                    ...
                    if (sorter != null)
                    {
                        ...
                        System.Windows.MessageBox.Show(elapsed1.ToString() + " seconds.");
                    ...
                    else
                    {
                        ...
                        System.Windows.MessageBox.Show(elapsed2.ToString() + " seconds.");
