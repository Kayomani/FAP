#region Licenced under The Code Project Open License (CPOL) 1.02 http://www.codeproject.com/KB/IP/networkshares.aspx
#endregion
using System;
using System.IO;
...
namespace Fap.Foundation
{
    ...
    #region SambaShare
    /// <summary>
    /// Information about a samba share
    /// </summary>
    public class SambaShare
    {
        ...
        public SambaShare(string server, string netName, string path, ShareType shareType, string remark)
        {
    ...
    public class ShareCollection : ReadOnlyCollectionBase
    {
        ...
        /// <returns></returns>
        public static SambaShare PathToShare(string fileName)
        {
        ...
        {
            InnerList.Add(new SambaShare(_server, netName, path, shareType, remark));
        }
        ...
        /// </summary>
        public SambaShare this[int index]
        {
            get { return (SambaShare)InnerList[index]; }
        }
